...
const Sidebar = () => {
    ...
    ${selectedUser ? "max-md:hidden" : " "}`}>
          ...
          w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
                ...
                <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5 '>
                    ...
                    <input onChange={(e)=>setInput(e.target.value)} placeholder='Search Users...' type="text" className='bg-transparent border-none outline-none text-white
